...
'''
    This node publishes the costmap based on the occupancy map and robot characteristics.
    Specifically, it applies an "inflation layer" to the obstacle map, circular regions
    around obstacles which mark areas where the center of the robot cannot travel.

    Subscriptions:
    /map/global:         OccupancyGrid, obstacle map generated by global_mapper
    /map/global_updates: OccupancyGridUpdate

    Publishes:
    /map/global_costmap: OccupancyGrid, the costmap
'''
